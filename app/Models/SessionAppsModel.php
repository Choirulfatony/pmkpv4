...
class SessionAppsModel extends Model
{
    ...
    public function checkLogin(array $where)
    {
        return $this->db->table('user_profile')
            ->select('user_profile.*, user_group.group_name as hak_akses, master_institution_department.department_name as lokasi, master_institution_department.department_id as department_id, user_profile.profile_photo as profile_photo')
