            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <small class="text-muted">
                        Monitoring indikator mutu Mutu Prioritas RS (IMPRS)
                    </small>
                </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $tahun.on('change', function() {
            ...
            $.ajax({
                url: '<?= site_url('siimut/grafik-imprs/indicators') ?>',
                type: 'POST',
                data: { tahun: newTahun },
                dataType: 'json',
                beforeSend: function() {
    ...
    function downloadGrafikPng() {
        ...
        link.download = 'Grafik_IMPRS_Tren_Bulanan_' + document.getElementById('tahun').value + '.jpg';
