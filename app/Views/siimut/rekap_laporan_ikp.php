        ...
        <div class="alert alert-light border alert-dismissible fade show" role="alert">
            <div class="d-flex align-items-start">
                ...
                <div class="flex-grow-1">
                    <h5 class="mb-1"><strong>Informasi Rekap Insiden Keselamatan Pasien (IKP)</strong></h5>
        ...
        <div class="card card-outline card-secondary" id="detail_satu">
            <div class="card-header">
                ...
                <div class="card-tools d-flex align-items-center gap-2 flex-wrap">
                    ...
                    <?php if (!empty($totalDraft) && $totalDraft > 0): ?>
                        ...
                        ?>
                        <a href="<?= site_url('siimut/approval/ikp') ?>" class="badge bg-warning text-dark text-decoration-none"
                    ...
                    <div class="btn-group btn-group-sm">
                        <button type="button" class="btn btn-outline-secondary" onclick="reload_table_ikp()" title="Refresh">
            ...
            <div class="card-body p-0">
                <div class="table-responsive p-3">
                    ...
                    <table id="ajax_data_rekap_ikp" class="table table-bordered table-hover table-striped mb-0" style="width: 100%;">
                        <thead>
...
<script>
    ...
    $(document).ready(function() {
        $('#tahun').val(vtahun);
        $('#btn-export').attr('href', '<?= site_url('siimut/rekap-laporan-ikp/export') ?>?tahun=' + vtahun);

        // Inisialisasi tooltip untuk badge draft
        var tooltipTriggerList = [].slice.call(document.querySelectorAll('[data-bs-toggle="tooltip"]'));
        tooltipTriggerList.map(function (el) { return new bootstrap.Tooltip(el); });

        table_loquin = $('#ajax_data_rekap_ikp').DataTable({
            processing: false,
            serverSide: true,
            autoWidth: false,
            pageLength: 10,
            ...
            ajax: {
                url: '<?= site_url('siimut/rekap-laporan-ikp/ajax_rekap_ikp') ?>',
                type: 'POST',
                data: function(d) {
                    d.vtahun = vtahun;
    ...
    function gantiTahun() {
        ...
        $('#btn-export').attr('href', '<?= site_url('siimut/rekap-laporan-ikp/export') ?>?tahun=' + vtahun);
        if (table_loquin) {
            table_loquin.ajax.url('<?= site_url('siimut/rekap-laporan-ikp/ajax_rekap_ikp') ?>').load();
        }
    }
    ...
    function reload_table_ikp() {
        vtahun = $('#tahun').val();
        console.log('reload_table_ikp called, vtahun:', vtahun);
    ...
    function view_detail_ikp(indicator_id) {
        window.location.href = '<?= site_url('siimut/rekap-laporan-ikp?indicator_id=') ?>' + indicator_id + '&tahun=' + vtahun;
    }
</script>
