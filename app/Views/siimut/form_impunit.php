    ...
    <div class="form-inm-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-end">
                ...
                <a href="<?= site_url('siimut/approval/impunit') ?>" class="btn btn-warning btn-sm">
                    <i class="bi bi-check2-square me-1"></i> Approval
                </a>
                <a href="<?= site_url('siimut/trash/impunit') ?>" class="btn btn-outline-danger btn-sm">
...
<script>
    ...
    function deleteData() {
        ...
        Swal.fire({
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', '<?= site_url('siimut/impunit/delete') ?>', true);
            xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200) {
    ...
    function validateData() {
        ...
        Swal.fire({
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', '<?= site_url('siimut/impunit/validasi') ?>', true);
            xhr.setRequestHeader('Content-Type', 'application/x-www-form-urlencoded');
            xhr.setRequestHeader('X-Requested-With', 'XMLHttpRequest');
            xhr.onreadystatechange = function() {
                if (xhr.readyState === 4 && xhr.status === 200) {
