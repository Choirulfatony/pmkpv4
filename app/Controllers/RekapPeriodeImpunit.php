...
class RekapPeriodeImpunit extends AppController
{
    ...
    public function exportExcel()
    {
        ...
        try {
            ...
            $filename = 'REKAP_PERIODE_IMPUnit_' . $tahun . '_' . date('YmdHis');
            ...
            log_message('error', 'Export Excel Rekap Periode IMPUnit Error: ' . $e->getMessage());
    ...
    private function buildSheet($sheet, $data, $type, $tahun)
    {
        ...
        $sheet->setCellValue('A1', 'REKAP INDIKATOR MUTU PRIORITAS UNIT (IMPUnit) - ' . $judul);
